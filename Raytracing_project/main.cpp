...
int main()
{
	...
	while (WM_QUIT != msg.message)
	{
		...
		else
		{
			...
			//ImGui::SliderFloat3("Center", &example->raytracer.sphere1->center.x, -1.0f, 1.0f);
			//ImGui::SliderFloat("Radius", &example->raytracer.sphere1->radius, 0.0f, 1.0f);
			//ImGui::SliderFloat3("Light", &example->raytracer.light.pos.x, -2.0f, 2.0f);
			//ImGui::SliderFloat3("Ambient color", &example->raytracer.sphere1->amb.x, 0.0f, 1.0f);
			//ImGui::SliderFloat3("Diffuse color", &example->raytracer.sphere1->dif.x, 0.0f, 1.0f);
			//ImGui::SliderFloat3("Specular color", &example->raytracer.sphere1->spec.x, 0.0f, 1.0f);
			//ImGui::SliderFloat("Specular power", &example->raytracer.sphere1->alpha, 0.0f, 100.0f);
